...
slate.Variants = (function () {
  ...
  Variants.prototype = _.assignIn({}, Variants.prototype, {
    ...
    _onSelectChange: function () {
      ...
      this._updateImageBasedOnOptionsChosen(variant);
     ...
     * @return {event} variantOptionsChange
     */
    _updateImageBasedOnOptionsChosen: function (variant) {
      this.$container.trigger({
        type: "variantOptionsChange",
        variant: variant,
      });
    },
...
theme.Product = (function () {
  function Product(container) {
    ...
    this.selectors = {
      ...
      imageChangeOption1: "[data-option1]",
      imageChangeOption2: "[data-option2]",
      imageChangeOption3: "[data-option3]",
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    _initVariants: function () {
      ...
      this.$container.on(
        "variantOptionsChange" + this.settings.namespace,
        this._updateImageBasedOnOptionsChosen.bind(this)
      );
    },
    ...
    /**
     * handle custom image change when selecting different options
     *
